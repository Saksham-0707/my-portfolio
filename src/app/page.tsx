...
const items = [
    {
        ...
        href: 'https://github.com/Saksham-0707',
    },
    {
        title: 'Twitter',
        icon: <IconBrandX stroke={2} />,
        href: 'https://x.com/Theprof35743201',
    },
    {
        title: 'LinkedIn',
        icon: <IconBrandLinkedin stroke={2} />,
        href: 'https://www.linkedin.com/in/saksham-doda-927377244/',
    },
    {
        title: 'Email',
        icon: <IconMail />,
        href: 'mailto:sakshamdoda11@gmail.com',
    },
];
...
export default function Home() {
    return (
        <div className="flex flex-col overflow-x-hidden">
            {/* Hero */}
            <header className="flex min-h-screen w-full flex-col items-center gap-7 pt-10">
                <Reveal
                ...
                >
                    <div className="rounded-[2rem] border border-border/70 bg-card/70 p-2 shadow-[0_20px_70px_-40px_rgba(15,23,42,0.55)] backdrop-blur">
                        <Image
                            src={mee3}
                            alt="profile"
                            className="size-96 rounded-[1.5rem] border border-border/60 object-cover transition duration-300 hover:scale-[1.02] hover:border-primary/50"
                        />
                    </div>
                </Reveal>
                <div className="flex flex-col justify-center items-center gap-2 w-full">
                    ...
                    >
                        <h3 className="scroll-m-20 bg-gradient-to-b from-foreground to-muted-foreground bg-clip-text text-center text-2xl font-semibold tracking-tight text-transparent">
                    ...
                    >
                        <p className="pt-2 text-center text-lg font-medium leading-7 text-muted-foreground">
                            I turn coffee into code, ideas into interfaces, and
                    ...
                    >
                        <Button
                            className="mt-5 h-12 w-48 rounded-full border border-primary/30 text-base shadow-[0_18px_45px_-24px_rgba(16,185,129,0.55)] transition duration-300 hover:scale-105 hover:border-primary/60 hover:shadow-[0_24px_55px_-24px_rgba(16,185,129,0.6)]"
                            onClick={() =>
                                document
            ...
            <section className="flex flex-col items-center justify-center gap-4 sm:py-32 py-16">
                ...
                >
                    <p className="flex text-wrap text-center text-base leading-8 text-muted-foreground sm:max-w-3xl">
                        I'am 20 year old developer from India, Currently
                        pursuing my B.Tech from Dr. B.R. Ambedkar National
                        Institute of Technology, Jalandhar (NIT Jalandhar). With
                        a background in Computer Science and a love for a knack
                        for turning ideas into reality. When I'm not coding, I
                        usually play video games, football or binge-watch
                        Animes.
                    </p>
                </Reveal>
            </section>
                        ...
                        <div className="flex flex-col items-center justify-center gap-2">
                            ...
                            <div className="flex flex-row flex-wrap justify-center gap-4">
                                ...
                                <div className="flex flex-col items-center justify-center">
                                    ...
                                    >
                                        <linearGradient
                                            id="kY2lFHytK6J7eR89ploKLa_2T6TKY6whzgV_gr1"
                                            x1="32.485"
                                            x2="32.485"
                                            y1="26.009"
                                            y2="39.6"
                                        ...
                                        <path
                                            fill="url(#kY2lFHytK6J7eR89ploKLa_2T6TKY6whzgV_gr1)"
                                            d="M26.07,35.31l6.17-3.6l6.66,3.92c-1.3,2.29-3.69,3.7-6.33,3.7 C29.73,39.33,27.26,37.69,26.07,35.31z"
                                        ></path>
                                        <linearGradient
                                            id="kY2lFHytK6J7eR89ploKLb_2T6TKY6whzgV_gr2"
                                            x1="32"
                                            x2="32"
                                            y1="27.121"
                                            y2="56.372"
                                        ...
                                        <path
                                            fill="url(#kY2lFHytK6J7eR89ploKLb_2T6TKY6whzgV_gr2)"
                                            d="M52.6,43.67v0.22L32,55.79l-20.6-11.9 l7.7-4.5c2.6,4.77,7.67,8.01,13.47,8.01c5.52,0,10.55-2.93,13.29-7.69L52.6,43.67z"
                                        ></path>
                                        <linearGradient
                                            id="kY2lFHytK6J7eR89ploKLc_2T6TKY6whzgV_gr3"
                                            x1="31.93"
                                            x2="31.93"
                                            y1="24.81"
                                            y2="35.29"
                                        ...
                                        <path
                                            fill="url(#kY2lFHytK6J7eR89ploKLc_2T6TKY6whzgV_gr3)"
                                            d="M38.55,27.97l-6.35,3.72h-0.01l-6.13,3.6 c-0.48-0.97-0.75-2.06-0.75-3.22c0-1.39,0.39-2.68,1.07-3.79c1.28-2.08,3.57-3.47,6.19-3.47C34.98,24.81,37.2,25.98,38.55,27.97z"
                                        ></path>
                                        <linearGradient
                                            id="kY2lFHytK6J7eR89ploKLd_2T6TKY6whzgV_gr4"
                                            x1="31.87"
                                            x2="31.87"
                                            y1="8.21"
                                            y2="43.89"
                                        ...
                                        <path
                                            fill="url(#kY2lFHytK6J7eR89ploKLd_2T6TKY6whzgV_gr4)"
                                            d="M45.12,24.1l0.39-0.24 c-2.83-4.45-7.67-7.12-12.94-7.12c-5.58,0-10.47,3-13.15,7.46c-1.38,2.31-2.18,4.99-2.18,7.87c0,2.65,0.67,5.13,1.85,7.3 l-7.69,4.52V20.11L32,8.21l20.34,11.75L45.12,24.1z"
                                        ></path>
                                        <linearGradient
                                            id="kY2lFHytK6J7eR89ploKLe_2T6TKY6whzgV_gr5"
                                            x1="15.25"
                                            x2="15.25"
                                            y1="32.704"
                                            y2="48.615"
                                        ...
                                        <path
                                            fill="url(#kY2lFHytK6J7eR89ploKLe_2T6TKY6whzgV_gr5)"
                                            d="M19.09,39.37c0,0.01,0.01,0.01,0.01,0.02 l-7.7,4.5L19.09,39.37z"
                                        ></path>
                                        <linearGradient
                                            id="kY2lFHytK6J7eR89ploKLf_2T6TKY6whzgV_gr6"
                                            x1="29.15"
                                            x2="29.15"
                                            y1="26.351"
                                            y2="39.094"
                                        ...
                                        <path
                                            fill="url(#kY2lFHytK6J7eR89ploKLf_2T6TKY6whzgV_gr6)"
                                            d="M32.24,31.71l-6.17,3.6 c0-0.01-0.01-0.01-0.01-0.02l6.13-3.6h0.01L32.24,31.71z"
                                        ></path>
                                        <linearGradient
                                            id="kY2lFHytK6J7eR89ploKLg_2T6TKY6whzgV_gr7"
                                            x1="15.25"
                                            x2="15.25"
                                            y1="30.671"
                                            y2="43.89"
                                        ...
                                        <path
                                            fill="url(#kY2lFHytK6J7eR89ploKLg_2T6TKY6whzgV_gr7)"
                                            d="M19.09,39.37c0,0.01,0.01,0.01,0.01,0.02 l-7.7,4.5L19.09,39.37z"
                                        ></path>
                                        <linearGradient
                                            id="kY2lFHytK6J7eR89ploKLh_2T6TKY6whzgV_gr8"
                                            x1="29.15"
                                            x2="29.15"
                                            y1="24.723"
                                            y2="35.31"
                                        ...
                                        <path
                                            fill="url(#kY2lFHytK6J7eR89ploKLh_2T6TKY6whzgV_gr8)"
                                            d="M32.24,31.71l-6.17,3.6 c0-0.01-0.01-0.01-0.01-0.02l6.13-3.6h0.01L32.24,31.71z"
                                        ></path>
                                        <linearGradient
                                            id="kY2lFHytK6J7eR89ploKLi_2T6TKY6whzgV_gr9"
                                            x1="42.27"
                                            x2="42.27"
                                            y1="13.698"
                                            y2="56.641"
                                        ...
                                        <polygon
                                            fill="url(#kY2lFHytK6J7eR89ploKLi_2T6TKY6whzgV_gr9)"
                                            points="52.34,19.96 32.24,31.71 32.2,31.69 38.55,27.97 45.12,24.1"
                                        ></polygon>
                                        <linearGradient
                                            id="kY2lFHytK6J7eR89ploKLj_2T6TKY6whzgV_gr10"
                                            x1="42.27"
                                            x2="42.27"
                                            y1="8.21"
                                            y2="43.887"
                                        ...
                                        <polygon
                                            fill="url(#kY2lFHytK6J7eR89ploKLj_2T6TKY6whzgV_gr10)"
                                            points="52.34,19.96 32.24,31.71 32.2,31.69 38.55,27.97 45.12,24.1"
                                        ></polygon>
                                        <linearGradient
                                            id="kY2lFHytK6J7eR89ploKLk_2T6TKY6whzgV_gr11"
                                            x1="32"
                                            x2="32"
                                            y1="1.255"
                                            y2="56.081"
                                        ...
                                        <path
                                            fill="url(#kY2lFHytK6J7eR89ploKLl_2T6TKY6whzgV_gr12)"
                                            d="M52.34,19.96l-20.1,11.75l6.66,3.92 l6.96,4.08l6.74,3.96V20.11L52.34,19.96z M44,33h-2v2h-2v-2h-2v-2h2v-2h2v2h2V33z M51,33h-2v2h-2v-2h-2v-2h2v-2h2v2h2V33z"
                                        ></path>
                                    </svg>
                                    <p className="text-sm text-muted-foreground">
                                        C++
            ...
            <section
                id="contact"
                className="flex flex-col items-center justify-center gap-8 py-24 sm:py-48"
            >
                <Reveal
                    initial={{ opacity: 0, y: 50 }}
                    whileInView={{
                ...
                >
                    <h2 className="scroll-m-20 bg-gradient-to-r from-foreground to-primary bg-clip-text text-3xl font-extrabold tracking-tight text-transparent lg:text-4xl">
                        Hey there
                    </h2>
                </Reveal>
                <Reveal
                ...
                >
                    <p className="text-clip text-center text-lg leading-7 text-muted-foreground sm:max-w-2xl">
                        If you have any questions, collaboration ideas, or just
                        want to connect, feel free to reach out through my
                        social channels.
                    </p>
                </Reveal>
                <div className="flex rounded-full border border-border/60 bg-card/60 px-5 py-6 shadow-[0_16px_50px_-34px_rgba(15,23,42,0.55)] backdrop-blur">
                    <Reveal
                        initial={{ opacity: 0, y: 50 }}
                        whileInView={{
                            opacity: 1,
                    ...
                    >
                        <FloatingDock
                            desktopClassName="text-primary transition duration-300 ease-in-out hover:scale-110"
                            mobileClassName="text-primary transition duration-300 ease-in-out hover:-translate-y-1 hover:scale-110"
                            items={items}
                        />
                    </Reveal>
                </div>
